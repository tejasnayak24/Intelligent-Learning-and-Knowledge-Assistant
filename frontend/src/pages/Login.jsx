...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    // TODO: Call authService.login(formData) -> handles POST /login
    // Upon receiving the token, store it securely (e.g., localStorage)

    // Simulating successful login and redirecting to dashboard
    navigate('/dashboard');
  };
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to access your study materials on <span className="font-semibold text-indigo-600">ILKA</span>
          </p>
        </div>
